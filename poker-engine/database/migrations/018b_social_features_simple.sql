-- Migration: Social Features (Simple)
-- Date: 2024-01-15
-- Purpose: Add social features without foreign key conflicts
...
-- Per-game aliases (without foreign key initially)
CREATE TABLE IF NOT EXISTS player_aliases (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    game_id VARCHAR(100) NOT NULL, -- Will add FK later if needed
    user_id UUID NOT NULL,
...
SELECT 'Migration 018b_social_features_simple completed - social features added' AS result;
